...
<%@page import="com.ram.adminlte.model.Operators"%>
...
<html>
  <head>
    ...
    <title>AdminLte | Operators</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <span class="label label-success">WhatsApp Only</span>
                      <%} %>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2005-2019 <a href="http://javatechnicforyou.blogspot.com/" target="_blank">Java4u</a>.</strong> All rights reserved.
      </footer>
