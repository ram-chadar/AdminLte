...
<%@page import="com.ram.adminlte.model.DownloadList"%>
...
<html>
  <head>
    ...
    <title>AdminLte | Downloads</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="dashboard.html" class="logo">
          ...
          <span class="logo-mini"><b>AdminLte</b></span>
	...
	%></p>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<%
				ArrayList<DownloadList> list =(ArrayList<DownloadList>) request.getAttribute("data");
			%>
        <!-- Main content -->
      ...
      <footer class="main-footer">
        ...
        </script> <a href="http://javatechnicforyou.blogspot.com/" target="_blank">Java4u</a>.</strong> All rights reserved.
      </footer>
