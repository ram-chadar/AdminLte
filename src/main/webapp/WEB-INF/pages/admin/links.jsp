...
<%@page import="com.ram.adminlte.model.Links"%>
...
<title>AdminLte | Useful Links</title>
	...
	<div class="wrapper">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tr>
										...
										<td><a href=<%out.println(name.getClick()); %> target="_blank"><span class="label label-success">Go
													!</span></a></td>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2005-2019 <a
				href="http://javatechnicforyou.blogspot.com/" target="_blank">Java4u</a>.
