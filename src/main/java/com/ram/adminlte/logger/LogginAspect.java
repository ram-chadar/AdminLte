package com.ram.adminlte.logger;
...
public class LogginAspect {
	@Before("execution(* com.ram.adminlte.controller.LoginController.checkLogin(..))")
	...
	@Before("execution(* com.ram.adminlte.service.LoginService.checkLogin(..))")
	...
	@Before("execution(* com.ram.adminlte.dao.LoginDao.checkUser(..))")
